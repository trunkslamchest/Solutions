...
// - since startTime.length == endTime.length, we can iterate through both at the same time
// - iterate through startTime and endTime
...
var busyStudent = function(startTime, endTime, queryTime) {
  let c = 0
  for(let i = 0; i < startTime.length; i++){ if(startTime[i] <= queryTime && endTime[i] >= queryTime) c++ }
  return c
};
